...
export function CTASection() {
  return (
    <section className="py-32 relative overflow-hidden bg-[#141214]">
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            ...
            >
              <source src="/images/b2.mp4" type="video/mp4" />
            </video>

            {/* Color Overlays */}
            <div className="absolute inset-0 bg-gradient-to-r from-black via-black/80 to-black/40 z-10" />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black/20 z-10" />
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#ef4444] mix-blend-screen opacity-20 blur-[100px] z-10 animate-pulse" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#591926] mix-blend-screen opacity-1 blur-[100px] z-10 animate-pulse delay-1000" />
          </div>
          ...
          <div className="relative z-20 p-12 md:p-24 w-full h-full flex flex-col md:flex-row items-center justify-between gap-12 bg-white/5 backdrop-blur-sm border border-white/10">
            <div className="flex-1 max-w-2xl text-left">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-xs font-bold tracking-[0.2em] uppercase mb-6 text-[#fbbf24] shadow-[0_0_15px_rgba(251,191,36,0.2)]">
                Start Your Project
              </span>
            ...
            <div className="flex flex-col sm:flex-row shrink-0 gap-4 mt-8 md:mt-0 w-full md:w-auto">
              ...
              >
                <Button
                  size="lg"
                  className="w-full sm:w-auto h-16 px-8 text-lg font-bold bg-[#7f1d1d] text-white border border-[#ef4444] hover:bg-[#ef4444] hover:border-[#ef4444] transition-all duration-300 rounded-full shadow-[0_0_20px_rgba(239,68,68,0.28)] hover:shadow-[0_0_40px_rgba(239,68,68,0.35)]"
                >
                  Request a Quote
