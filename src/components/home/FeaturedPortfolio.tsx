...
const portfolioItems = [
  ...
  },
  {
    ...
    color: "from-[#EC008C]/20 to-transparent",
  },
  {
    ...
    color: "from-[#FFF200]/20 to-transparent",
  },
  {
      ...
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 mb-10 w-full shrink-0 flex flex-col md:flex-row items-end justify-between gap-6 z-10">
          ...
          <Link href="/portfolio" className="shrink-0 mb-4 hidden md:block">
            <Button size="lg" className="group rounded-full bg-white text-black hover:bg-white/90 font-semibold px-8 h-14">
              View Entire Gallery
        ...
        <motion.div style={{ x }} className="flex gap-8 px-4 md:px-6 w-[300vw] lg:w-[200vw]">
          {portfolioItems.map((item, index) => (
            <div
              key={index}
              className="group relative w-[85vw] sm:w-[500px] lg:w-[700px] rounded-[2.5rem] overflow-hidden aspect-[4/3] bg-[#050505] border border-white/10 shrink-0"
            >
          ...
          <div className="group relative w-[85vw] sm:w-[400px] lg:w-[500px] rounded-[2.5rem] overflow-hidden bg-gradient-to-br from-[#050505] to-[#111] border border-white/10 shrink-0 flex flex-col items-center justify-center text-center p-12">
            <div className="absolute inset-0 bg-gradient-to-tr from-[#00AEEF]/10 via-[#EC008C]/10 to-[#FFF200]/10 opacity-50 group-hover:opacity-100 transition-opacity duration-700" />
            ...
            <Link href="/portfolio" className="relative z-10">
              <Button size="lg" className="rounded-full bg-white text-black hover:bg-white/90 hover:scale-105 transition-all w-16 h-16 p-0 flex items-center justify-center shadow-[0_0_30px_rgba(255,255,255,0.2)]">
