...
import { Check, Package, Sparkles, Layers, Box } from "lucide-react";
    ...
    <div className="pt-32 pb-0 bg-[#020202] min-h-screen">
      <div className="container mx-auto px-4 md:px-6 mb-32 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs uppercase tracking-[0.2em] font-bold text-[#EC008C] mb-8 backdrop-blur-md">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black mb-6 tracking-tighter leading-[1.05]">
              Custom Box <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#EC008C] to-[#FFF200]">Packaging</span>
            </h1>
            ...
            <div className="space-y-5">
              {[
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-[#EC008C]/10 flex items-center justify-center shrink-0 border border-[#EC008C]/20 shadow-[0_0_15px_rgba(236,0,140,0.2)]">
                    <Check size={14} className="text-[#EC008C]" />
                  </div>
                  <span>{item}</span>
                </motion.div>
              ))}
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-[#EC008C]/30 via-[#FFF200]/10 to-transparent rounded-full blur-[100px] pointer-events-none z-0" />
            
            <div className="relative rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl z-10 transform-gpu transition-all duration-700 hover:scale-[1.02] hover:shadow-[#EC008C]/20 group">
            ...
            >
              <div className="flex items-center gap-4">
                <Box className="w-10 h-10 text-[#EC008C]" />
                <div>
      ...
      <section className="py-32 relative overflow-hidden bg-[#050505] border-y border-white/5">
        {/* Abstract background */}
        <div className="absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#EC008C]/50 to-transparent" />
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center text-center mb-20">
            ...
            >
              Premium <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/40">Finishes</span>
            </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 xl:gap-8 cursor-default">
            {[
              { title: "Hot Foil Stamping", desc: "Add luxurious metallic gold, silver, rose-gold, or holographic accents to critical typography and logos.", color: "group-hover:text-[#FFF200]" },
              { title: "Embossing & Debossing", desc: "Create a highly engaging tactile 3D effect that customers can physically feel when they touch your product.", color: "group-hover:text-[#EC008C]" },
              { title: "Spot UV Coating", desc: "Highlight specific design elements with a high-gloss, raised finish that pops vividly against a matte background.", color: "group-hover:text-[#00AEEF]" },
              ...
              <motion.div 
                ...
                className="group bg-[#0a0a0a] border border-white/5 p-10 md:p-12 rounded-[2rem] hover:bg-white/5 hover:border-white/20 transition-all duration-500 relative overflow-hidden"
              >
                {/* Number mark */}
                <div className="absolute top-6 right-8 text-6xl font-black text-white/[0.02] group-hover:text-white/5 transition-colors duration-500 pointer-events-none">
                  0{i + 1}
                </div>
