  ...
  return (
    <div className="pt-32 pb-0 bg-[#020202] min-h-screen">
      ...
      <div className="relative overflow-hidden mb-16">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-bl from-[#EC008C]/10 to-transparent rounded-[100%] blur-[100px] pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-[#00AEEF]/10 to-transparent rounded-[100%] blur-[100px] pointer-events-none" />
        ...
        <div className="container relative z-10 mx-auto px-4 md:px-6 text-center max-w-4xl pt-10 pb-16">
          ...
          >
            Engineered for <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00AEEF] via-[#EC008C] to-[#FFF200]">Prestige</span>
          </motion.h1>
      ...
      <section className="py-32 bg-black relative" id="details">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="space-y-40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" id="offset-printing">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#00AEEF]/20 to-transparent rounded-[2.5rem] blur-2xl opacity-50 group-hover:opacity-80 transition-opacity duration-500" />
              ...
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">
                  <span className="block text-[#00AEEF] text-2xl tracking-widest uppercase mb-2 font-bold">01</span>
                  Offset Printing
                </h2>
                ...
                <ul className="space-y-4 text-white/80 font-medium text-lg">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-4">
                      <div className="w-8 h-8 rounded-full bg-[#00AEEF]/10 flex items-center justify-center border border-[#00AEEF]/20 text-[#00AEEF]">
                        ✓
                      </div>
                      {item}
                    </li>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" id="labels">
              ...
              >
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">
                  <span className="block text-[#FFF200] text-2xl tracking-widest uppercase mb-2 font-bold">02</span>
                  Labels & Stickers
                </h2>
                <p className="text-xl text-white/50 font-light leading-relaxed mb-8">
                ...
                <ul className="space-y-4 text-white/80 font-medium text-lg">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-4">
                      <div className="w-8 h-8 rounded-full bg-[#FFF200]/10 flex items-center justify-center border border-[#FFF200]/20 text-[#FFF200]">
                        ✓
                      </div>
                      {item}
                    </li>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-tr from-[#FFF200]/20 to-transparent rounded-[2.5rem] blur-2xl opacity-50 group-hover:opacity-80 transition-opacity duration-500" />
