    ...
    <div className="pt-32 pb-24 bg-[#141214] min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          >
            Detail your specifications below. Our estimators will engineer a
            tailored proposal optimizing cost without compromising prestige.
          </motion.p>
        </div>
          ...
          <form action={formAction} ref={formRef} className="space-y-10">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-4 border-b border-white/10 pb-4">
                <div className="w-8 h-8 rounded-full bg-[#ef4444]/10 text-[#ef4444] border border-[#ef4444]/20 flex items-center justify-center font-bold text-sm">
                  1
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    name="name"
                    required
                    className="bg-[#241b20] border-white/5 focus-visible:border-[#ef4444]/30 focus-visible:ring-0 h-14 rounded-xl px-5 text-lg"
                    placeholder="John Doe"
                  />
                </div>
                <div className="space-y-3">
                  <Label htmlFor="company" className="text-white/70 ml-1">
                    Company Name
                  </Label>
                  <Input
                    type="text"
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-4 border-b border-white/10 pb-4">
                <div className="w-8 h-8 rounded-full bg-[#fbbf24]/10 text-[#fbbf24] border border-[#fbbf24]/20 flex items-center justify-center font-bold text-sm">
                  2
                </div>
                <h3 className="text-2xl font-bold text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <Label htmlFor="service_type" className="text-white/70 ml-1">
                    Primary Requirement *
                  </Label>
                ...
                <div className="space-y-3">
                  <Label htmlFor="quantity" className="text-white/70 ml-1">
                    Estimated Quantity
                  </Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-3">
                  <Label htmlFor="dimensions" className="text-white/70 ml-1">
                  ...
                  <Input
                    ...
                    name="dimensions"
                    className="bg-[#241b20] border-white/5 focus-visible:border-[#ef4444]/30 focus-visible:ring-0 h-14 rounded-xl px-5 text-lg"
                    placeholder="e.g. A4, 10x10x5cm"
                  />
                </div>
                <div className="space-y-3">
                  <Label htmlFor="material" className="text-white/70 ml-1">
                    Preferred Stock / Material
                  </Label>
                  <Input
                    type="text"
                    id="material"
                    name="material"
                    className="bg-[#241b20] border-white/5 focus-visible:border-[#ef4444]/30 focus-visible:ring-0 h-14 rounded-xl px-5 text-lg"
                    placeholder="e.g. 350gsm Artboard, Kraft"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                <Label htmlFor="file" className="text-white/70 ml-1">
                  Artwork or Reference File
                </Label>
                <div className="relative group rounded-xl border-2 border-dashed border-white/10 hover:border-[#fbbf24]/30 bg-[#241b20] hover:bg-[#1a1a1a] transition-all duration-300 overflow-hidden">
                  ...
                  <div className="flex flex-col items-center justify-center p-8 text-center pointer-events-none">
                    <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center mb-4 group-hover:bg-white/10 transition-colors">
                      <UploadCloud
                        className={`w-6 h-6 ${fileName ? "text-[#fbbf24]" : "text-white/50 group-hover:text-[#fbbf24]"}`}
                      />
                    </div>
                    {fileName ? (
                      <>
                        <p className="text-base text-[#fbbf24] mb-1 font-medium break-all">
                          {fileName}
                        </p>
                      ...
                      <>
                        <p className="text-base text-white/70 mb-1 font-medium">
                          Click or drag file to upload
                        </p>
                        <p className="text-sm text-white/40">
                          PDF, AI, PSD, ZIP up to 25MB
                        </p>
                      </>
                    )}
                  </div>
            ...
            <Button
              type="submit"
              disabled={isPending}
              className="w-full h-16 text-lg font-bold bg-[#7f1d1d] text-white hover:bg-[#ef4444] transition-all duration-300 shadow-[0_0_30px_rgba(239,68,68,0.28)] hover:shadow-[0_0_40px_rgba(239,68,68,0.35)] rounded-xl mt-8 group flex items-center justify-center overflow-hidden relative"
            >
            ...
            {state?.success && (
              ...
              >
                ...
                <p className="text-green-400/70 text-sm">
                  A print specialist will review your brief and contact you
                  within 24 hours.
                </p>
              </motion.div>
            )}
